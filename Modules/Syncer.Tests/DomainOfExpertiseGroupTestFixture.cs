...
namespace Syncer.Tests
{
    ...
    public class DomainOfExpertiseGroupTestFixture
    {
        ...
        [Test]
        public async Task VerifySyncNewDomainGroup()
        {
            // setup
            var domainGroup = new DomainOfExpertiseGroup(Guid.NewGuid(), 0);
            this.sourceSiteDirectory.DomainGroup.Add(domainGroup.Iid);
            AddToThings(this.sourceThings, domainGroup);
            ...
            await syncer.Sync(new List<Guid> { domainGroup.Iid });

            Assert.AreEqual(3, this.targetThings.Count);
            Assert.IsTrue(this.targetThings.ContainsKey(domainGroup.Iid));
        }

        [Test]
        public async Task VerifySyncNewDomainGroupContained()
        {
            // setup
            var domainGroup = new DomainOfExpertiseGroup(Guid.NewGuid(), 0);
            this.sourceSiteDirectory.DomainGroup.Add(domainGroup.Iid);
            ...
            domainGroup.Definition.Add(definition.Iid);
        ...
        [Test]
        public async Task VerifySyncNewDomainGroupReferenced()
        {
            // setup
            var domainGroup = new DomainOfExpertiseGroup(Guid.NewGuid(), 0);
            this.sourceSiteDirectory.DomainGroup.Add(domainGroup.Iid);
            ...
            domainGroup.Domain.Add(domain.Iid);
            ...
            Assert.IsTrue(this.targetThings.ContainsKey(definition.Iid));
            Assert.IsTrue(this.targetThings.ContainsKey(citation.Iid));
            Assert.IsFalse(this.targetThings.ContainsKey(domain.Iid));
            Assert.IsFalse(this.targetThings.ContainsKey(referenceSource.Iid));
        }

        [Test]
        public async Task VerifySyncExistingDomainGroup()
        {
            // setup
            var domainGroup = new DomainOfExpertiseGroup(Guid.NewGuid(), 0);
            this.sourceSiteDirectory.DomainGroup.Add(domainGroup.Iid);
            AddToThings(this.sourceThings, domainGroup);
            this.targetSiteDirectory.DomainGroup.Add(domainGroup.Iid);
            AddToThings(this.targetThings, domainGroup);
        ...
        [Test]
        public async Task VerifySyncExistingDomainGroupContained()
        {
            // setup
            var commonDomainGroupSource = new DomainOfExpertiseGroup(Guid.NewGuid(), 0);
            this.sourceSiteDirectory.DomainGroup.Add(commonDomainGroupSource.Iid);
            AddToThings(this.sourceThings, commonDomainGroupSource);

            var commonDomainGroupTarget = new DomainOfExpertiseGroup(commonDomainGroupSource.Iid, 0);
            this.targetSiteDirectory.DomainGroup.Add(commonDomainGroupTarget.Iid);
            AddToThings(this.targetThings, commonDomainGroupTarget);

            var commonDefinitionSource = new Definition(Guid.NewGuid(), 0);
            commonDomainGroupSource.Definition.Add(commonDefinitionSource.Iid);
            ...
            commonDomainGroupTarget.Definition.Add(commonDefinitionTarget.Iid);
            AddToThings(this.targetThings, commonDefinitionTarget);

            var newDefinition = new Definition(Guid.NewGuid(), 0);
            commonDomainGroupSource.Definition.Add(newDefinition.Iid);
            ...
            Assert.AreEqual(5, this.targetThings.Count);
            Assert.IsTrue(this.targetThings.ContainsKey(commonDomainGroupTarget.Iid));
            ...
            await syncer.Sync(new List<Guid> { commonDomainGroupSource.Iid });
        ...
        [Test]
        public async Task VerifySyncExistingDomainGroupReferenced()
        {
            // setup
            var commonDomainGroupSource = new DomainOfExpertiseGroup(Guid.NewGuid(), 0);
            this.sourceSiteDirectory.DomainGroup.Add(commonDomainGroupSource.Iid);
            ...
            // references
            var domain = new DomainOfExpertise(Guid.NewGuid(), 0);
            commonDomainGroupSource.Domain.Add(domain.Iid);
            AddToThings(this.sourceThings, domain);
