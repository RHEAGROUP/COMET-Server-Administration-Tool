...
namespace Migration.ViewModels
{
    ...
    public class FixCardinalityErrorsDialogViewModel : ReactiveObject, IFixCardinalityErrorsDialogViewModel
    {
        ...
        public void BindPocoErrors()
        {
            ...
            {
                CDPMessageBus.Current.SendMessage(new LogEvent { Message = "The source session is not defined", Type = typeof(MigrationViewModel) });
                return;
            }
        ...
        private void ExecuteFixCommand()
        {
            ...
            CDPMessageBus.Current.SendMessage(new LogEvent { Message = "Fixing the cardinality errors for the selected models...", Type = typeof(MigrationViewModel) });
