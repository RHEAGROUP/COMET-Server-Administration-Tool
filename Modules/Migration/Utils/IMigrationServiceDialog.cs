// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMigrationServiceDialog.cs" company="RHEA System S.A.">
...
namespace Migration.Utils
{
    ...
    /// <summary>
    /// The interface for the <see cref="MigrationServiceDialog"/>
    /// </summary>
    public interface IMigrationServiceDialog
    {
        ...
        bool? OpenMigrationFileDialog(string initialDirectory, string extensionFilter);
