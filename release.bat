...
set version=%1
set buildpath=.\SAT\bin\Release\net48\*
set filename=COMET-Server-Administration-Tool-%version%.zip
...
ECHO Releasing SAT Version %version%
...
call MSBuild.exe CDP4-SAT.sln /property:Configuration=Release
