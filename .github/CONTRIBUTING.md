...
1. Configure the upstream repo (`git remote add upstream git://github.com/RHEAGROUP/CDP4-Server-Administration-Tool`) 
...
And remember; **A pull-request with tests is a pull-request that's likely to be pulled in.** :grin: Bonus points if you document your feature in our [wiki](https://github.com/RHEAGROUP/CDP4-Server-Administration-Tool/wiki) once it has been pulled in
